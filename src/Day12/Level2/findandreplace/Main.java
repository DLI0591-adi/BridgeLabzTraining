package Day12.Level2.findandreplace;
...
public class Main {
    public static void main(String[] args) {
        Path originalFilePath = Paths.get("src/Day12/Level2/findandreplace/original.txt");
        Path tempFilePath = Paths.get("src/Day12/Level2/findandreplace/temp.txt");
