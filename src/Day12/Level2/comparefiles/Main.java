package Day12.Level2.comparefiles;
...
public class Main {
    ...
    public static void main(String[] args) {
        Path filePath1 = Paths.get("src/Day12/Level2/comparefiles/file1.txt");
        Path filePath2 = Paths.get("src/Day12/Level2/comparefiles/file2.txt");
