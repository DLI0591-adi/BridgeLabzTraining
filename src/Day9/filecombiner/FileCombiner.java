...
public class FileCombiner {
    ...
    public static void main(String[] args) {
        String file1Path = "src/Day9/filecombiner/file1.txt";
        String file2Path = "src/Day9/filecombiner/file2.txt";
        String outputPath = "src/Day9/filecombiner/combined_output.txt";
